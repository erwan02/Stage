 // Gestion du mode accessibilité
        ...
        if (form) {
            form.addEventListener('submit', function(e) {
                ...
                if (!objetInput || !(objetInput as HTMLInputElement).value.trim()) {
                ...
                if (!contenuTextarea || !(contenuTextarea as HTMLTextAreaElement).value.trim()) {
